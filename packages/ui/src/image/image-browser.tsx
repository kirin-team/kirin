...
export type ImageAnchorProps = Omit<AnchorHTMLAttributes<any>, keyof LinkProps>;
...
function getTitle(title: string, colors: BrowserColors) {
  return (
    <div className="title">
      {title}
...
export default withScale(ImageBrowser);
