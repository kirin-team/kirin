...
import { CopyTypes, NormalTypes, SnippetTypes } from '../utils/prop-types';
...
function textArrayToString(text: string[]) {
...
export default withScale(Snippet);
