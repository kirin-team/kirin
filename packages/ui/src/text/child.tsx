import { DetailsHTMLAttributes, useMemo } from 'react';
...
function getTypeColor(type: NormalTypes, palette: KirinThemesPalette) {
...
type NativeAttrs = Omit<DetailsHTMLAttributes<any>, keyof Props>;
export type TextChildProps = Props & NativeAttrs;

export default function TextChild({
  children,
  tag,
  className = '',
  type = 'default',
