...
export interface ToastAction {
  name: string;
  handler: (event: MouseEvent<HTMLButtonElement>, cancel: () => void) => void;
  passive?: boolean;
}
...
export default function useToasts(layout?: ToastLayout): ToastHooksResult {
  ...
  useEffect(() => {
    ...
    updateToastLayout(() =>
      layout ? { ...defaultToastLayout, ...layout } : defaultToastLayout
    );
  }, []);
