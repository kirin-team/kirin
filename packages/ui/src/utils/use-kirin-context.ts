...
import type { Toast, ToastLayout } from '../use-toasts/use-toast';
...
export interface KirinContextParams {
  toasts: Array<Toast>;
...
const defaultParams: KirinContextParams = {
  toasts: [],
...
export const KirinContent = createContext(defaultParams);
export const useKirinContext = () => useContext(KirinContent);
